  ...
  return (
        <div>
          <div className="post-content">
            <img src="http://placehold.it/1920x1280" alt="an image" className="img-responsive post-image" />
          ...
          <div className="post-content">
            <img src="http://placehold.it/2000x1300" alt="post-image" className="img-responsive post-image" />
            <div className="post-container">
              <img src="http://placehold.it/300x300" alt="user" className="profile-photo-md pull-left" />
              <div className="post-detail">
                <div className="user-info">
          ...
          <div className="post-content">
            <img src="http://placehold.it/1920x1160" alt="" className="img-responsive post-image" />
            <div className="post-container">
              <img src="http://placehold.it/300x300" alt="user" className="profile-photo-md pull-left" />
              <div className="post-detail">
                <div className="user-info">
